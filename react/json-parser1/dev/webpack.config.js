...
module.exports = (env, argv) => ({
	...
	*/
	...
	resolve: {
		alias: {
			  $comp: path.resolve(__dirname, 'src/app/blocks/components'),
			  $cont: path.resolve(__dirname, 'src/app/blocks/containers'),
			   $hoc: path.resolve(__dirname, 'src/app/blocks/hoc'),

		     $store: path.resolve(__dirname, 'src/app/api/store'),
 		     $total: path.resolve(__dirname, 'src/app/api/total'),
		     $utils: path.resolve(__dirname, 'src/app/api/utils'),
